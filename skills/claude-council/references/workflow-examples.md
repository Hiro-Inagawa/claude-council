...
**User trigger:** "Council this: I'm thinking of building a $297 course on Claude Code for beginners. My audience is mostly non-technical solopreneurs. Is this the right move?"

**Framed question:**

> Deciding whether to build and launch a $297 course on using Claude Code, targeted at non-technical solopreneurs. Context: audience has no coding background; AI tools course market is crowded; creator has subject matter expertise and an existing audience. At stake: 4–8 weeks of production time, potential revenue, and positioning in the AI education space. Should this product be built as proposed, modified, or replaced with a different offer?

**Topic slug:** `course-launch-decision`
...
For the `{{CONTRARIAN_STANCE}}` / `{{EXPANSIONIST_STANCE}}` etc. fields in the HTML report, write 1–2 short sentences capturing the pass's main position — not a quote, a distillation. Examples:
